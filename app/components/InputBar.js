...
const TestFieldStyle={
    ...
    return (
        <div className="inputBar flex-container-row">
            <TextField id="new-list-item-txt-box" type="text" hintText="Upload a new Reference" onKeyUp={(e)=>{grabValue(e)}} underlineStyle={{display: 'none'}} style={TestFieldStyle} ></TextField>
